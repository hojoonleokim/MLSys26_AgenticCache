...
Reproduce Table 4 from the paper:
  "Cold-start results on long-horizon tasks (6000 frame limit)"

Paper claim: AgenticCache (Ours / Ours+) improves over baseline in cold-start
scenarios with 30-object environments under the 6000-frame budget.
...
BASE = os.path.join(SCRIPT_DIR, "results", "table4")
...
# ─────────────────────────────────────────────────────────────────────────────
# Table 2 & 3: Cold-start results from results/table4/
# ─────────────────────────────────────────────────────────────────────────────
...
if __name__ == "__main__":
    print("=" * 60)
    print("Reproducing Table 4: Cold-start results (6000 frame limit)")
    print("Paper: AgenticCache (MLSys 2026)")
    print("=" * 60)
    generate_table23("30objs", 6000, 4)
    print("\nDone. LaTeX output saved to table4.tex")
